...
def run(settings):
    ...
    # Train sampler and loader   todo: 这里改了！
    ...
    dataset_val = sampler.RandomImage([zurich_raw2rgb_val], [1],
                                      samples_per_epoch=settings.batch_size * 500, processing=data_processing_val)
    ...
    optimizer = optim.AdamW([{'params': actor.net.parameters(), 'lr': 2e-6}]) # 2e-4
